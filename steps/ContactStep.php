	...
	public function Process() { 
		...
		if ($_POST['enq_submitted'] == "TRUE") {
		        ...
		        if ($oSalesEnquiry->Process()) {
	        		$message = "<h1>Thanks for your Enquiry</h1>";
					$message .= "<p>One of our team will contact you shortly.</p>"; 
					$oMessage = new Message(MESSAGE_TYPE_SUCCESS, 'contact_request', $message);
