<div id="review" class="row">
	<ul class="nav nav-tabs">
	  <li class="nav-item"><a class="nav-link <?= ($this->Get('HAS_REVIEW')) ? "active" : ""; ?>" id="review-display-lnk" data-toggle="tab" href="#review-display">Comments</a></li>
	  <li class="nav-item"><a class="nav-link <?= (!$this->Get('HAS_REVIEW')) ? "active" : ""; ?>" id="review-add-lnk" data-toggle="tab" href="#review-add">Leave a reply</a></li>
	</ul>
	<div class="tab-content">
		<div id="review-display" class="">
			...
			if (count($aReview) >=5)
				{ ?>
    		<div class="my-2">
    			<a href="#" class="btn btn-primary rounded-pill px-3" id="review-viewall">View All Comments</a>
    		</div>
    		...
    		<div id="review-add-form">
    			...
    			<input type="hidden" id="review-type" name="review-type" value="comment" />
    		  	...
    		  	<div class="form-group my-2">
    				<label for="review-review">Comment / Feedback:</label>
