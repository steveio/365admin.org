...
<div class="search-result row-fluid">
	...
	<script id="cTWide" type="text/template">
        ...
        <% if (profile_type == 1) { %>
            	<div class="img-container" style="width: 36%; float: left;">
			<div class="featured-proj-img span12">
		...
		<div class="details" style="float: right; width: 60%">
                <div class="proj-title span12" style="">
                   <div class="title span12" style="">
            	   <h3><a href="<%= profile_url %>" title="<%= title %>" target="_new"><%= title %></a></h3>
                   </div>
                   <% if (review_rating >= 1) { %>
	           <div style="float: left; width: 100%;">
                   <div id="rateYo-<%= id %>" class="rating span12"></div>
		   </div>
                   <% } %>
		   <div style="float: left; width: 100%;">
                   <ul class="" style="width: 100%; margin-left: 15px;">
		...
		<div class="details-org">
			<% if (logo_url.length > 1) { %>
			   <div class="pull-right logo" style="width: 40%;">
