...
$aActivity = $this->Get('aActivities');
$aDestination = $this->Get('aDestinations');
...
<div class="row my-3">
	...
	<? } ?>
      <?
    	...
    	<?php 
    	foreach($aActivity as $key => $arr)
    	{ 
    	    $a = $arr[0];
    	    ?>
    	       <div class="card">
    	       <div class="card-header">
    	       <h2><a href="/<?= $a['category_url_name']; ?>" title="<?= $key; ?>"><?= $key; ?></a></h2>
    	       </div>
    	       <div class="card-body">
    	       <ul>
    	       <?
    	       foreach($arr as $row)
    	       {
    	       print "<li><a href='/".$row['activity_url_name']."' title='".$row['activity_name']."'>".$row['activity_name']."</a></li>";
    	       }
    	      	?>
    	       </ul>
    	       </div>
    	...
    	<div class="row row-cols-1 row-cols-md-2 g-4">
    	<?php 
    	foreach($aDestination as $key => $arr)
    	{ 
    	    $a = $arr[0];
    	    ?>
    	       <div class="card">
    	       <div class="card-header">
    	       <h2><a href="/continent/<?= $a['continent_url_name']; ?>" title="<?= $key; ?>"><?= $key; ?></a></h2>
    	       </div>
    	       <div class="card-body">
    	       <ul>
    	       <?
    	       foreach($arr as $row)
    	       {
    	       print "<li><a href='/travel/".$row['country_url_name']."' title='".$row['country_name']."'>".$row['country_name']."</a></li>";
    	       }
    	      	?>
    	       </ul>
    	       </div>
