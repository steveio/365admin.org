...
<div class="row">
<h2>Teaching Projects / Courses</h2>
</div>
...
<div class="row">
	<span class="label_col"><label for="<?= PROFILE_FIELD_TEACHING_NO_TEACHERS; ?>" style="<?= strlen($response['msg'][PROFILE_FIELD_TEACHING_NO_TEACHERS]) > 1 ? "color:red;" : ""; ?>">No Teachers / Jobs</label></span>
	<span class="input_col">
	<?= $this->Get('NUMBER_OF_TEACHERS'); ?>
	<br /><span class="p_small grey">No of teachers / placements offered by your organisation (jobs only)</span>
	</span>
</div>
...
<div class="row">
	...
	<span class="input_col"><textarea id="<?= PROFILE_FIELD_TEACHING_SALARY; ?>" name="<?= PROFILE_FIELD_TEACHING_SALARY; ?>" class="textarea_01" /><?= stripslashes($_POST[PROFILE_FIELD_TEACHING_SALARY]); ?></textarea>
...
<div class="row">
	...
	<span class="input_col"><textarea id="<?= PROFILE_FIELD_TEACHING_BENEFITS; ?>" name="<?= PROFILE_FIELD_TEACHING_BENEFITS; ?>" class="textarea_01" /><?= stripslashes($_POST[PROFILE_FIELD_TEACHING_SALARY]); ?></textarea>
...
<div class="row">
	...
	<span class="input_col"><textarea id="<?= PROFILE_FIELD_TEACHING_QUALIFICATIONS; ?>" name="<?= PROFILE_FIELD_TEACHING_QUALIFICATIONS; ?>" class="textarea_01" /><?= stripslashes($_POST[PROFILE_FIELD_TEACHING_QUALIFICATIONS]); ?></textarea>
...
<div class="row">
	...
	<span class="input_col"><textarea id="<?= PROFILE_FIELD_TEACHING_REQUIREMENTS; ?>" name="<?= PROFILE_FIELD_TEACHING_REQUIREMENTS; ?>" class="textarea_01" /><?= stripslashes($_POST[PROFILE_FIELD_TEACHING_REQUIREMENTS]); ?></textarea>
...
<div class="row">
	...
	<span class="input_col"><textarea id="<?= PROFILE_FIELD_TEACHING_HOW_TO_APPLY; ?>" name="<?= PROFILE_FIELD_TEACHING_HOW_TO_APPLY; ?>" class="textarea_01" /><?= stripslashes($_POST[PROFILE_FIELD_TEACHING_HOW_TO_APPLY]); ?></textarea></span>
</div>