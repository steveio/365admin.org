...
<div class="row800">
	<span class="input_col">
		<input type="submit" title="Create a new article" onclick="javascript: window.location = './article-editor'; return false;" name="new" value="New Article" class="sub_col_but" />
