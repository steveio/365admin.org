...
class ArchiveManager {
	...
	public function ArchivePlacement($id) {
		...
		try {
			...
			$this->Archive__DeleteExistingProfileArchive();
	...
	private function Archive__DeleteExistingProfileArchive() {

		global $db;

		if ($this->GetProfileType() == PROFILE_VOLUNTEER) {
			$sql = "DELETE FROM profile_general_archive WHERE p_hdr_id = ".$this->GetObjectId().";";
		} elseif ($this->GetProfileType() == PROFILE_TOUR) {		
			$sql = "DELETE FROM profile_tour_archive WHERE p_hdr_id = ".$this->GetObjectId().";";
		...
		$sql = "DELETE FROM image_map_archive WHERE link_to = 'PLACEMENT' AND link_id = ".$this->GetObjectId().";";
		$db->query($sql);
	...
	private function Archive__CompanyExtendedProfile() {
		...
		} elseif ($this->GetProfileType() == PROFILE_VOLUNTEER_PROJECT) {
