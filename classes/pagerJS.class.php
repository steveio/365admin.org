	    ...
	    if ($this->GetNumPages() > 1) {
	        ...
	        for ($i=$this->GetStartIdx(); $i<=$this->GetEndIdx(); $i++) {
	            ...
	            if($i == $this->GetStartIdx() && $this->GetPageNum() > 1) {
	                $out .= "<li class='page-item'><a class='page-link' href=\"#\" id=\"pageid_".($i-1)."\">«</a></li>";
	            }
	            ...
	            if ($i==$this->GetPageNum()) {
	                ...
	                $qs = "?&".$this->GetPagerId()."=".$i; //.$this->GetQueryStr();
	                $out .= "<li class='page-item'><a class='page-link' href=\"#\" id=\"pageid_".$i."\" title=\"View Page ".$i."\">".$i."</a></li>";
	            }
	            
	            if ($i == $this->GetEndIdx() && $this->GetPageNum() < $this->GetNumPages()) {
	                $out .= "<li class='page-item'><a class='page-link' id=\"pageid_".($i+1)."\" href=\"#\" title=\"Next\">»</a></li> ";
	            }
	        }
