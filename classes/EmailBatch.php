        ...
        foreach($aId as $id) {
            ...
            try {
                ...
                if ($this->Process()) {
                    ...
                    sleep(3); // wait for postfix send log and  prevent spam policy violation and/or memory spike when sending large email batches
                    
                    $this->ProcessMailLogDeliveryStatus($oEnquiry->GetId());
